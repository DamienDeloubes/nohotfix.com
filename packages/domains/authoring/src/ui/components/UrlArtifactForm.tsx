...
export interface UrlArtifactFormData {
  type: 'url';
  label: string;
  description: string;
  required: boolean;
...
interface UrlArtifactFormProps {
  data: UrlArtifactFormData;
  index: number;
  onChange: (data: UrlArtifactFormData) => void;
  disabled?: boolean | undefined;
  errors?: { label?: string; description?: string } | undefined;
}

export function UrlArtifactForm({ data, index, onChange, disabled, errors }: UrlArtifactFormProps) {
    ...
    <div style={{ flex: 1 }}>
      <div style={{ marginBottom: '0.5rem' }}>
        ...
        <input
          ...
          placeholder="e.g. CI Pipeline URL"
          disabled={disabled}
      ...
      <div style={{ marginBottom: '0.5rem' }}>
        ...
        <textarea
          ...
          placeholder="e.g. Provide the GitHub Actions run URL for the main branch build"
          disabled={disabled}
          rows={2}
          style={{
            width: '100%',
